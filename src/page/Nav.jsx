...
const navTheme = 'text-bgLight3 dark:text-cyan outline-none text-xl z-50 transition'

const navMenu = 'z-50 md:hidden outline-none text-bgLight3 dark:text-cyan '
...
const blur = 'w-full md:hidden h-screen backdrop-blur-sm absolute top-0 left-0'
