...
const parentInput = 'grid grid-cols-2 gap-2'
...
const btn = 'px-4 col-span-2 group py-2 rounded border-bgLight3 dark:border-cyan  outline-none border text-bgLight3 dark:text-cyan font-semibold font-ls my-2 hover:bg-bgLight3 hover:text-bgLight1 dark:hover:bg-bg2 flex justify-center gap-3 items-center'
